...
หลักสูตร: การพัฒนากำลังคนสำหรับนักพัฒนาเว็บแอปพลิเคชันและแอปพลิเคชันบนอุปกรณ์เคลื่อนที่เพื่อเข้าสู่บริษัทซอฟต์แวร์ชั้นนำ (Nxt Gen IT KKU)
...
พัฒนาระบบสำหรับบันทึก วางแผน และติดตามกำหนดส่งงาน เพื่อช่วยให้ผู้ใช้เห็นงานที่ใกล้ถึงกำหนด งานที่ครบกำหนด และงานที่เสร็จแล้วได้อย่างรวดเร็ว ลดโอกาสพลาดกำหนดส่ง พร้อมติดตามความคืบหน้าของงานได้ตั้งแต่ 0–100% ทั้งบนคอมพิวเตอร์และโทรศัพท์มือถือ
...
## กลุ่มผู้ใช้งานเป้าหมาย
ระบบ Deadline ช่วยให้การจัดการกำหนดส่งงานเป็นเรื่องง่าย เข้าถึงข้อมูลสำคัญได้รวดเร็ว และยังใช้งานต่อได้แม้ไม่มีอินเทอร์เน็ต ในอนาคตสามารถต่อยอดด้วยระบบสมาชิก การแจ้งเตือน การซิงก์ข้อมูลหลายอุปกรณ์ และการจัดการข้อมูลขัดแย้งระหว่างอุปกรณ์
...
## live demo
[Vercel](https://nxt-project-deadline.vercel.app/)
